...
export default function EditEventPage() {
  ...
  const fetchEvent = async () => {
    try {
      ...
      if (user?.role !== 'admin' && eventData.organizer._id !== user?._id) {
        ...
        <div className="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-3xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label htmlFor="time" className="block text-sm font-semibold text-white/80 mb-1">
                  Time *
                </label>
                <input
                  type="time"
              ...
              <div>
                <label htmlFor="duration" className="block text-sm font-semibold text-white/80 mb-1">
                  Duration (minutes) *
                </label>
                <input
                  type="number"
                  ...
                  placeholder="120"
                />
                <p className="mt-1 text-xs text-white/60">Minimum 15 minutes, maximum 24 hours</p>
              </div>
